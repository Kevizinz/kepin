      ...
      items: [
        {
          ...
          github: 'https://github.com/kevizinz/kepin',
          demo: 'https://kevin-akbarr.vercel.app/'
        },
        {
          id: 2,
          name: 'Kalkulator',
          imageUrl: 'sahabatmuslim',
          status: 'Website that has a calculator display to make it easier to use when using.',
          tech: 'VueJS 3, Tailwind',
          github: 'https://github.com/Kevizinz/kevizinz',
          demo: 'https://kevizinz.vercel.app/'
        },
        {
          id: 3,
          name: 'SISTEKDES',
